...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Vérification si les éléments HTML existent
    ...
    if (!calendar || !monthYear || !prevMonthBtn || !nextMonthBtn || !trainingDetails) {
        console.error("Certains éléments HTML sont introuvables. Vérifiez l'intégration.");
        return;
    }
    ...
    function showTrainingDetails(day) {
        ...
        trainingInfo.textContent = "Séance d'entraînement prévue..."; // Ajoutez ici les données dynamiques
